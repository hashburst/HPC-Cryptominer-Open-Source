...
Integrate PostHog with React SDK: [https://posthog.com/docs/libraries/react](https://posthog.com/docs/libraries/react)

##### Automated Installation

###### AI setup wizard (BETA)
...
###### Add environment variables
        ...
        VITE_PUBLIC_POSTHOG_KEY=phc_CBplwMQFqSCrydF1dCukwnDaWnwyvXoPmu4utmFFzQU
        VITE_PUBLIC_POSTHOG_HOST=https://eu.i.posthog.com

###### Initialize

Integrate PostHog at the root of your app (such as main.tsx if you're using Vite).
